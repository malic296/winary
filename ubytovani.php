    ...
    <div class="ubyt-content">
        <div class="ubyt">
            ...
            <div class="ubyt-text1">
                <h2>Apartmán 1</h2>
                Vinotéka je součástí vinařství, kde se může každý stavit pro víno nejlépe po telefonické dohodě, celoročně od 8:00 do 16:00hod.<br>Objednávky příjímáme na telefonním čísle <br>+420 606 715 417.<br><br>Počet osob:<br>-max. 6 + možnost přistýlky<br><br>Vybavení:<br>- kuchyňka<br>- sociální zařízení<br>- wifi<br>- tv<br>- lednice<br>- klimatizace<br>
            </div>
        </div>
        <div class="ubyt">
