...
function move(){
    document.getElementById('header').classList.toggle('dolu');
}
function btn(){
...
function larger1(){
    document.getElementById('menu-item-id1').classList.toggle('larger');
    document.getElementById('menu-item-id1').classList.remove('shrink');
}
function shrink2(){
    document.getElementById('menu-item-id2').classList.toggle('shrink');
    document.getElementById('menu-item-id2').classList.remove('larger');
}
function larger2(){
    document.getElementById('menu-item-id2').classList.toggle('larger');
    document.getElementById('menu-item-id2').classList.remove('shrink');
}
function shrink3(){
    document.getElementById('menu-item-id3').classList.toggle('shrink');
    document.getElementById('menu-item-id3').classList.remove('larger');
}
function larger3(){
    document.getElementById('menu-item-id3').classList.toggle('larger');
    document.getElementById('menu-item-id3').classList.remove('shrink');
}
function shrink4(){
    document.getElementById('menu-item-id4').classList.toggle('shrink');
    document.getElementById('menu-item-id4').classList.remove('larger');
}
function larger4(){
    document.getElementById('menu-item-id4').classList.toggle('larger');
    document.getElementById('menu-item-id4').classList.remove('shrink');
}
function shrink5(){
    document.getElementById('menu-item-id5').classList.toggle('shrink');
    document.getElementById('menu-item-id5').classList.remove('larger');
}
function larger5(){
    document.getElementById('menu-item-id5').classList.toggle('larger');
    document.getElementById('menu-item-id5').classList.remove('shrink');
}
function shrink6(){
    document.getElementById('menu-item-id6').classList.toggle('shrink');
    document.getElementById('menu-item-id6').classList.remove('larger');
}
function larger6(){
    document.getElementById('menu-item-id6').classList.toggle('larger');
    document.getElementById('menu-item-id6').classList.remove('shrink');
}
function shrink7(){
    document.getElementById('menu-item-id7').classList.toggle('shrink');
    document.getElementById('menu-item-id7').classList.remove('larger');
}
function larger7(){
